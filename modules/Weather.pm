...
API::Std::mod_init('Weather', 'Arinity', '1.01', '3.0.0a11');
...
This module requires XML::Simple. It is obtainable from 
CPAN <http://www.cpan.org>.

This module is compatible with Auto version 3.0.0a11+.
